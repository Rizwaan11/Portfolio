...
export const featuredProject = {
  ...
  desc: "EduQuest turns passive course material into active, social learning. Students upload PDFs and a RAG pipeline (LangChain + Gemini embeddings + MongoDB Vector Search) answers questions grounded in their own documents and auto-generates quizzes. A full gamification engine plus real-time multiplayer coding competitions keep learners engaged — backed by a self-hosted Piston service that safely runs 15+ languages in a Docker sandbox, secured with Google OAuth 2.0 + JWT across a REST API.",
  stats: [
  ...
  features: [
    ...
    "Google OAuth 2.0 + JWT auth across a REST API",
  ],
